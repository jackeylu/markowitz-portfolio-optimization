...
min_return = 0.03								# Minimum desired return
...
while date_index_iter + 20 < end_index:
	...
	portfolio_alloc = MarkowitzOpt(
	    shift_returns_mean.loc[date], # mean
		shift_returns_var.loc[date],  # variance
		covariance.loc[date], # co-variance
